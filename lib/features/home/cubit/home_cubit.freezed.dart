...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(League league) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(League league)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.league});
  ...
  @override
  String toString() {
    return 'HomeState.loaded(league: $league)';
  }
...
abstract class _Loaded implements HomeState {
  const factory _Loaded({required final League league}) = _$LoadedImpl;
